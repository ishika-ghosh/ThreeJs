...
function PhotoCard({ children, id, color, link }) {
...
export const FirstCard = ({ id, color, imageUrl, link }) => {
  return (
    <PhotoCard id={id} color={color} link={link}>
...
export const SecondCard = ({ id, color, imageUrl, link }) => {
  return (
    <PhotoCard id={id} color={color} link={link}>
      <div className="w-[95%] h-[95%] rounded-3xl overflow-hidden flex items-center justify-center">
        <img
...
export const ThirdCard = ({ id, color, imageUrl, link }) => {
  return (
    <PhotoCard id={id} color={color} link={link}>
      <div className="w-[95%] h-[95%] rounded-3xl overflow-hidden flex items-center justify-center">
        <img
